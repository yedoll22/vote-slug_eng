...
export default function SignUp () {
  ...
  const [userInfo, setUserInfo] = useState({email:'', password:'', nickname:'', gender: '', dob: ''});
  ...
  return (
    ...
    <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
        <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">SignUp</h1>
        <form>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="nickname">Nickname</label>
                <input class="border py-2 px-3 text-grey-800" type="text" name="nickname" />
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="email">e-mail</label>
                <input class="border py-2 px-3 text-grey-800" type="text" name="email" />
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="password">Password</label>
                <input class="border py-2 px-3 text-grey-800" type="text" name="password1" onChange={passwordHandler('password1')} />
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="password_confirm">Password Confirm </label>
                <input class="border py-2 px-3 text-grey-800" type="text" name="password2" onChange={passwordConfirmHandler('password2')} />
      ...
      <div class="relative">
        ...
        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
          <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
            ...
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="dateOfBirth">DOB</label>
                <input class="border py-2 px-3 text-grey-800" type="text" name="dateOfBirth" placeholder="yyyymmdd"/>
            </div>
            <button onClick={onSubmit} class="block bg-teal-400 hover:bg-teal-600 text-white uppercase text-lg mx-auto p-4 rounded">Confirm</button>
